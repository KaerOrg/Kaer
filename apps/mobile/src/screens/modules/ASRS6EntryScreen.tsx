...
import { saveASRS6Entry, generateId } from '../../lib/database'
import { ASRS6_DATA, computeASRS6Score } from '../../data/asrs6'
...
const ITEMS = ASRS6_DATA.items
const OPTIONS = ASRS6_DATA.options
...
export default function ASRS6EntryScreen() {
  ...
  const handleSubmit = async () => {
    ...
    await saveASRS6Entry({
      id: generateId(),
      answers: answersAsNumbers,
      total_score: computeASRS6Score(answersAsNumbers),
