...
import { TOPIC_VISUAL } from './chronoBioFicheData'
...
export default function ChronoBioDetailScreen() {
  ...
  const accentColor = visual?.color ?? teenColor('chronobiology_tracker') ?? colors.primary
  const title   = i18next.t(`chronobiology_tracker.${topicKey}.title`,   { ns: 'psyedu' })
  const tagline = i18next.t(`chronobiology_tracker.${topicKey}.summary`, { ns: 'psyedu' })
