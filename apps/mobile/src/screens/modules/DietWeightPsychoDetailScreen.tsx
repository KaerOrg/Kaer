...
import { TOPIC_VISUAL } from './dietWeightPsychoFicheData'
import { colors, spacing } from '../../theme'

type RouteProps = RouteProp<AppStackParamList, 'DietWeightPsychoDetail'>

export default function DietWeightPsychoDetailScreen() {
  ...
  const accentColor = visual?.color ?? teenColor('diet_weight_psycho') ?? colors.primary
  const title   = i18next.t(`diet_weight_psycho.${topicKey}.title`,   { ns: 'psyedu' })
  const tagline = i18next.t(`diet_weight_psycho.${topicKey}.summary`, { ns: 'psyedu' })
