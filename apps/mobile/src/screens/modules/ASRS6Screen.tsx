...
import { getAllASRS6Entries, deleteASRS6Entry, type ASRS6Entry } from '../../lib/database'
...
// Lien vers la publication de validation Kessler et al. (2005)
...
export default function ASRS6Screen() {
  const navigation = useNavigation<Nav>()
  const { isTeenMode, tt, teenColor } = useTeen()
  const accentColor = teenColor('asrs6')

  const [entries, setEntries] = useState<ASRS6Entry[]>([])
  const [loading, setLoading] = useState(true)

  useFocusEffect(
    useCallback(() => {
      let active = true
      getAllASRS6Entries().then(data => {
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.header}>
          <View style={styles.headerRow}>
            <Text style={typography.h2}>ASRS v1.1 — Dépistage</Text>
            <Pressable
                ...
                <View style={styles.cardMain}>
                  ...
                  <View style={styles.scoreRow}>
                    ...
                    <Text style={[
                      ...
                      {entry.total_score}
                      <Text style={styles.scoreMax}> / 24</Text>
                    </Text>
                  </View>
                </View>
                <Pressable
