...
/**
 * Répartit des fields entre leurs sections (`section_id`) et les fields hors
 * section. Utilisé par les layouts `steps`, `cards`, `guided_exercise` et
 * `editable_steps` — l'ordre d'insertion est préservé.
 */
