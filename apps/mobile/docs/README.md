# Documentation — App mobile patient

Documentation spécifique à `apps/mobile` (React Native + Expo). Pour la doc transversale du monorepo, voir [`docs/`](../../../docs/README.md).

## Index

| Document | Contenu |
|---|---|
| [`design-system.md`](design-system.md) | StyleSheet patterns, composants primitifs, widgets, **catalogue des layouts du ModuleRenderer**, Teen mode, tokens visuels |
