      ...
      <div className="spd__layout">
        <aside className="spd__side">
          ...
          <Card header={{ title: t('scales.entry_detail.follow_up_title') }}>
            {/* Accusé de lecture (#419) : la date de PREMIÈRE ouverture. Rappel adressé
                au praticien, jamais montré au patient. Absente tant que personne n'a
                ouvert, et aucun état intermédiaire ne la remplace. */}
