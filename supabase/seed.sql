...
insert into public.field_props (field_id, prop_key, prop_value) values
  ...
  -- Puce « à compléter » : une fiche sans toutes les complete_key_* porte ce
...
insert into public.field_props (field_id, prop_key, prop_value) values
  ...
  -- Étapes 4 & 5 (proches / professionnels) : items « contactables » (nom + numéro appelable).
  ('crisis_plan.step_4.title', 'contactable', 'true'),
