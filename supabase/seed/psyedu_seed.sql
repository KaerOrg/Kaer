...
where module_key in ('diet_weight_psycho', 'cognitive_distortions');
...
values
  -- Psychotropes & alimentation — section "Médicaments & alimentation" (sort_order 1-5)
  ...
  -- Hygiène de vie — section "Hygiène de vie" (sort_order 6-8)
  ('00000001-0000-0000-0000-000000000001', 'diet_weight_psycho','sleep_chrono',    'Moon',       6),
  ('00000001-0000-0000-0000-000000000002', 'diet_weight_psycho','nutrition_brain', 'Apple',      7),
  ('00000001-0000-0000-0000-000000000003', 'diet_weight_psycho','gentle_activity', 'Footprints', 8),
...
values
  ...
  ('00000001-0000-0000-0000-000000000001', 'how', 'action_list', null,
    array[
      'diet_weight_psycho.sleep_chrono.how.action1',
      'diet_weight_psycho.sleep_chrono.how.action2',
      'diet_weight_psycho.sleep_chrono.how.action3',
      'diet_weight_psycho.sleep_chrono.how.action4',
      'diet_weight_psycho.sleep_chrono.how.action5'
    ], null, 1),
...
values
  ...
  ('00000001-0000-0000-0000-000000000002', 'how', 'action_list', null,
    array[
      'diet_weight_psycho.nutrition_brain.how.action1',
      'diet_weight_psycho.nutrition_brain.how.action2',
      'diet_weight_psycho.nutrition_brain.how.action3',
      'diet_weight_psycho.nutrition_brain.how.action4',
      'diet_weight_psycho.nutrition_brain.how.action5'
    ], null, 1),
...
values
  ...
  ('00000001-0000-0000-0000-000000000003', 'how', 'action_list', null,
    array[
      'diet_weight_psycho.gentle_activity.how.action1',
      'diet_weight_psycho.gentle_activity.how.action2',
      'diet_weight_psycho.gentle_activity.how.action3',
      'diet_weight_psycho.gentle_activity.how.action4',
      'diet_weight_psycho.gentle_activity.how.action5'
    ], null, 1),
...
insert into public.psyedu_blocks
  (topic_id, section_key, block_type, text_code, items_codes, href, sort_order)
values
  -- why : ce que sont les distorsions + la liste des 10 (référence)
  ...
  -- how : la méthode en 3 questions (carte d'action)
  ('00000001-0000-0000-0000-000000000010', 'how', 'action_list', null,
    array[
