...
| [`moduleService.ts`](../apps/mobile/src/services/moduleService.ts) | `fetchPatientModuleConfig`, `isModuleUnlocked` (le `fetchModuleFields` partagé est ré-exporté depuis `@kaer/shared`) |
